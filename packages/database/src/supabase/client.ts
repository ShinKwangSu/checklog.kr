// =============================================================================
// checklog.kr MVP — Supabase 브라우저 클라이언트
// =============================================================================
//
...
// - anon 키는 RLS 를 우회하지 않으므로, RLS 정책(account_id 격리)이 그대로
//   적용된다. 다만 set_config 로 app.current_account_id 를 주입하지 않으면
//   fail-closed(0행)가 되므로, 멀티고객 데이터 접근은 원칙적으로 Server
